...
GmGame.start(player1=humanPlayer3,player2=aiPlayer0,max_time_to_move=1000,showIntermediateMoves=True) # don't speciry an aiPlayer for Human vs Human games
